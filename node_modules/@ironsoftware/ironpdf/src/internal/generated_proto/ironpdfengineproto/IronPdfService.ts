// Original file: src/internal/IronPdfEngine.ProtoFiles/iron_pdf_service.proto
...
import type { PdfiumSetPdfAttachmentDataRequestStreamP as _ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP, PdfiumSetPdfAttachmentDataRequestStreamP__Output as _ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP__Output } from '../ironpdfengineproto/PdfiumSetPdfAttachmentDataRequestStreamP';
...
import type { SystemIsValidLicenseRequestP as _ironpdfengineproto_SystemIsValidLicenseRequestP, SystemIsValidLicenseRequestP__Output as _ironpdfengineproto_SystemIsValidLicenseRequestP__Output } from '../ironpdfengineproto/SystemIsValidLicenseRequestP';
import type { SystemSetIsDebugRequestP as _ironpdfengineproto_SystemSetIsDebugRequestP, SystemSetIsDebugRequestP__Output as _ironpdfengineproto_SystemSetIsDebugRequestP__Output } from '../ironpdfengineproto/SystemSetIsDebugRequestP';
import type { SystemSetLicenseKeyRequestP as _ironpdfengineproto_SystemSetLicenseKeyRequestP, SystemSetLicenseKeyRequestP__Output as _ironpdfengineproto_SystemSetLicenseKeyRequestP__Output } from '../ironpdfengineproto/SystemSetLicenseKeyRequestP';

export interface IronPdfServiceClient extends grpc.Client {
  Chrome_HeaderFooter_AddHtmlHeaderFooter(argument: _ironpdfengineproto_ChromeAddHtmlHeaderFooterRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Chrome_HeaderFooter_AddHtmlHeaderFooter(argument: _ironpdfengineproto_ChromeAddHtmlHeaderFooterRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Chrome_HeaderFooter_AddHtmlHeaderFooter(argument: _ironpdfengineproto_ChromeAddHtmlHeaderFooterRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Chrome_HeaderFooter_AddHtmlHeaderFooter(argument: _ironpdfengineproto_ChromeAddHtmlHeaderFooterRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  chromeHeaderFooterAddHtmlHeaderFooter(argument: _ironpdfengineproto_ChromeAddHtmlHeaderFooterRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  chromeHeaderFooterAddHtmlHeaderFooter(argument: _ironpdfengineproto_ChromeAddHtmlHeaderFooterRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  chromeHeaderFooterAddHtmlHeaderFooter(argument: _ironpdfengineproto_ChromeAddHtmlHeaderFooterRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  chromeHeaderFooterAddHtmlHeaderFooter(argument: _ironpdfengineproto_ChromeAddHtmlHeaderFooterRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Chrome_Image_ImageFilesToPdf(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageFilesToPdfRequestStreamP>;
  Chrome_Image_ImageFilesToPdf(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageFilesToPdfRequestStreamP>;
  Chrome_Image_ImageFilesToPdf(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageFilesToPdfRequestStreamP>;
  Chrome_Image_ImageFilesToPdf(callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageFilesToPdfRequestStreamP>;
  chromeImageImageFilesToPdf(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageFilesToPdfRequestStreamP>;
  chromeImageImageFilesToPdf(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageFilesToPdfRequestStreamP>;
  chromeImageImageFilesToPdf(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageFilesToPdfRequestStreamP>;
  chromeImageImageFilesToPdf(callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageFilesToPdfRequestStreamP>;
  
  Chrome_Image_ImageToPdf(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageToPdfRequestStreamP>;
  Chrome_Image_ImageToPdf(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageToPdfRequestStreamP>;
  Chrome_Image_ImageToPdf(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageToPdfRequestStreamP>;
  Chrome_Image_ImageToPdf(callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageToPdfRequestStreamP>;
  chromeImageImageToPdf(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageToPdfRequestStreamP>;
  chromeImageImageToPdf(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageToPdfRequestStreamP>;
  chromeImageImageToPdf(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageToPdfRequestStreamP>;
  chromeImageImageToPdf(callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeImageToPdfRequestStreamP>;
  
  Chrome_Render_ApplyCookies(argument: _ironpdfengineproto_ChromeApplyCookiesRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Chrome_Render_ApplyCookies(argument: _ironpdfengineproto_ChromeApplyCookiesRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Chrome_Render_ApplyCookies(argument: _ironpdfengineproto_ChromeApplyCookiesRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Chrome_Render_ApplyCookies(argument: _ironpdfengineproto_ChromeApplyCookiesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  chromeRenderApplyCookies(argument: _ironpdfengineproto_ChromeApplyCookiesRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  chromeRenderApplyCookies(argument: _ironpdfengineproto_ChromeApplyCookiesRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  chromeRenderApplyCookies(argument: _ironpdfengineproto_ChromeApplyCookiesRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  chromeRenderApplyCookies(argument: _ironpdfengineproto_ChromeApplyCookiesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Chrome_Render_ClearCookies(argument: _ironpdfengineproto_ChromeClearCookiesRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Chrome_Render_ClearCookies(argument: _ironpdfengineproto_ChromeClearCookiesRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Chrome_Render_ClearCookies(argument: _ironpdfengineproto_ChromeClearCookiesRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Chrome_Render_ClearCookies(argument: _ironpdfengineproto_ChromeClearCookiesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  chromeRenderClearCookies(argument: _ironpdfengineproto_ChromeClearCookiesRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  chromeRenderClearCookies(argument: _ironpdfengineproto_ChromeClearCookiesRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  chromeRenderClearCookies(argument: _ironpdfengineproto_ChromeClearCookiesRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  chromeRenderClearCookies(argument: _ironpdfengineproto_ChromeClearCookiesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Chrome_Render_FromHtml(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromHtmlRequestStreamP>;
  Chrome_Render_FromHtml(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromHtmlRequestStreamP>;
  Chrome_Render_FromHtml(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromHtmlRequestStreamP>;
  Chrome_Render_FromHtml(callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromHtmlRequestStreamP>;
  chromeRenderFromHtml(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromHtmlRequestStreamP>;
  ...
  Chrome_Render_FromUri(argument: _ironpdfengineproto_ChromeRenderPdfDocumentFromUriRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  chromeRenderFromUri(argument: _ironpdfengineproto_ChromeRenderPdfDocumentFromUriRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  chromeRenderFromUri(argument: _ironpdfengineproto_ChromeRenderPdfDocumentFromUriRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  chromeRenderFromUri(argument: _ironpdfengineproto_ChromeRenderPdfDocumentFromUriRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  chromeRenderFromUri(argument: _ironpdfengineproto_ChromeRenderPdfDocumentFromUriRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  
  Chrome_Render_FromZipFile(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromZipFileRequestStreamP>;
  Chrome_Render_FromZipFile(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromZipFileRequestStreamP>;
  Chrome_Render_FromZipFile(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromZipFileRequestStreamP>;
  Chrome_Render_FromZipFile(callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromZipFileRequestStreamP>;
  chromeRenderFromZipFile(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromZipFileRequestStreamP>;
  ...
  Chrome_Render_RtfToPdf(callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromRtfStringRequestStreamP>;
  chromeRenderRtfToPdf(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromRtfStringRequestStreamP>;
  chromeRenderRtfToPdf(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromRtfStringRequestStreamP>;
  chromeRenderRtfToPdf(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromRtfStringRequestStreamP>;
  chromeRenderRtfToPdf(callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeRenderPdfDocumentFromRtfStringRequestStreamP>;
  
  Chrome_Stamp_ApplyStamp(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeApplyStampRequestStreamP>;
  Chrome_Stamp_ApplyStamp(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeApplyStampRequestStreamP>;
  Chrome_Stamp_ApplyStamp(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeApplyStampRequestStreamP>;
  Chrome_Stamp_ApplyStamp(callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeApplyStampRequestStreamP>;
  chromeStampApplyStamp(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_ChromeApplyStampRequestStreamP>;
  ...
  Pdfium_Annotation_AddTextAnnotation(argument: _ironpdfengineproto_PdfiumAddTextAnnotationRequestP, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationAddTextAnnotation(argument: _ironpdfengineproto_PdfiumAddTextAnnotationRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationAddTextAnnotation(argument: _ironpdfengineproto_PdfiumAddTextAnnotationRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationAddTextAnnotation(argument: _ironpdfengineproto_PdfiumAddTextAnnotationRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationAddTextAnnotation(argument: _ironpdfengineproto_PdfiumAddTextAnnotationRequestP, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Annotation_EditTextAnnotation(argument: _ironpdfengineproto_PdfiumEditTextAnnotationRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Annotation_EditTextAnnotation(argument: _ironpdfengineproto_PdfiumEditTextAnnotationRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Annotation_EditTextAnnotation(argument: _ironpdfengineproto_PdfiumEditTextAnnotationRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Annotation_EditTextAnnotation(argument: _ironpdfengineproto_PdfiumEditTextAnnotationRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationEditTextAnnotation(argument: _ironpdfengineproto_PdfiumEditTextAnnotationRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationEditTextAnnotation(argument: _ironpdfengineproto_PdfiumEditTextAnnotationRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationEditTextAnnotation(argument: _ironpdfengineproto_PdfiumEditTextAnnotationRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationEditTextAnnotation(argument: _ironpdfengineproto_PdfiumEditTextAnnotationRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Annotation_GetAnnotationCountRequestP(argument: _ironpdfengineproto_PdfiumGetAnnotationCountRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Annotation_GetAnnotationCountRequestP(argument: _ironpdfengineproto_PdfiumGetAnnotationCountRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Annotation_GetAnnotationCountRequestP(argument: _ironpdfengineproto_PdfiumGetAnnotationCountRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Annotation_GetAnnotationCountRequestP(argument: _ironpdfengineproto_PdfiumGetAnnotationCountRequestP, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationGetAnnotationCountRequestP(argument: _ironpdfengineproto_PdfiumGetAnnotationCountRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_Annotation_GetTextAnnotationRequestP(argument: _ironpdfengineproto_PdfiumGetAnnotationRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetTextAnnotationResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationGetTextAnnotationRequestP(argument: _ironpdfengineproto_PdfiumGetAnnotationRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetTextAnnotationResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationGetTextAnnotationRequestP(argument: _ironpdfengineproto_PdfiumGetAnnotationRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetTextAnnotationResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationGetTextAnnotationRequestP(argument: _ironpdfengineproto_PdfiumGetAnnotationRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetTextAnnotationResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationGetTextAnnotationRequestP(argument: _ironpdfengineproto_PdfiumGetAnnotationRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetTextAnnotationResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Annotation_RemoveAnnotation(argument: _ironpdfengineproto_PdfiumRemoveAnnotationRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Annotation_RemoveAnnotation(argument: _ironpdfengineproto_PdfiumRemoveAnnotationRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Annotation_RemoveAnnotation(argument: _ironpdfengineproto_PdfiumRemoveAnnotationRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Annotation_RemoveAnnotation(argument: _ironpdfengineproto_PdfiumRemoveAnnotationRequestP, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationRemoveAnnotation(argument: _ironpdfengineproto_PdfiumRemoveAnnotationRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationRemoveAnnotation(argument: _ironpdfengineproto_PdfiumRemoveAnnotationRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationRemoveAnnotation(argument: _ironpdfengineproto_PdfiumRemoveAnnotationRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAnnotationRemoveAnnotation(argument: _ironpdfengineproto_PdfiumRemoveAnnotationRequestP, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Attachment_AddPdfAttachment(argument: _ironpdfengineproto_PdfiumAddPdfAttachmentRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumAddPdfAttachmentResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Attachment_AddPdfAttachment(argument: _ironpdfengineproto_PdfiumAddPdfAttachmentRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumAddPdfAttachmentResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Attachment_AddPdfAttachment(argument: _ironpdfengineproto_PdfiumAddPdfAttachmentRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumAddPdfAttachmentResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Attachment_AddPdfAttachment(argument: _ironpdfengineproto_PdfiumAddPdfAttachmentRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumAddPdfAttachmentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentAddPdfAttachment(argument: _ironpdfengineproto_PdfiumAddPdfAttachmentRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumAddPdfAttachmentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentAddPdfAttachment(argument: _ironpdfengineproto_PdfiumAddPdfAttachmentRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumAddPdfAttachmentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentAddPdfAttachment(argument: _ironpdfengineproto_PdfiumAddPdfAttachmentRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumAddPdfAttachmentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentAddPdfAttachment(argument: _ironpdfengineproto_PdfiumAddPdfAttachmentRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumAddPdfAttachmentResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Attachment_GetPdfAttachmentCount(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentCountRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentCountResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Attachment_GetPdfAttachmentCount(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentCountRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentCountResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Attachment_GetPdfAttachmentCount(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentCountRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentCountResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Attachment_GetPdfAttachmentCount(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentCountRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentCountResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentGetPdfAttachmentCount(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentCountRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentCountResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentGetPdfAttachmentCount(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentCountRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentCountResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentGetPdfAttachmentCount(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentCountRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentCountResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentGetPdfAttachmentCount(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentCountRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentCountResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Attachment_GetPdfAttachmentData(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentDataRequestP, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_PdfiumGetPdfAttachmentDataResultStreamP__Output>;
  Pdfium_Attachment_GetPdfAttachmentData(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentDataRequestP, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_PdfiumGetPdfAttachmentDataResultStreamP__Output>;
  pdfiumAttachmentGetPdfAttachmentData(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentDataRequestP, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_PdfiumGetPdfAttachmentDataResultStreamP__Output>;
  pdfiumAttachmentGetPdfAttachmentData(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentDataRequestP, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_PdfiumGetPdfAttachmentDataResultStreamP__Output>;
  
  Pdfium_Attachment_GetPdfAttachmentName(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentNameRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentNameResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Attachment_GetPdfAttachmentName(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentNameRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentNameResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Attachment_GetPdfAttachmentName(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentNameRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentNameResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Attachment_GetPdfAttachmentName(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentNameRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentNameResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentGetPdfAttachmentName(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentNameRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentNameResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentGetPdfAttachmentName(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentNameRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentNameResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentGetPdfAttachmentName(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentNameRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentNameResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentGetPdfAttachmentName(argument: _ironpdfengineproto_PdfiumGetPdfAttachmentNameRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfAttachmentNameResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Attachment_RemovePdfAttachment(argument: _ironpdfengineproto_PdfiumRemovePdfAttachmentRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Attachment_RemovePdfAttachment(argument: _ironpdfengineproto_PdfiumRemovePdfAttachmentRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Attachment_RemovePdfAttachment(argument: _ironpdfengineproto_PdfiumRemovePdfAttachmentRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Attachment_RemovePdfAttachment(argument: _ironpdfengineproto_PdfiumRemovePdfAttachmentRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentRemovePdfAttachment(argument: _ironpdfengineproto_PdfiumRemovePdfAttachmentRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentRemovePdfAttachment(argument: _ironpdfengineproto_PdfiumRemovePdfAttachmentRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentRemovePdfAttachment(argument: _ironpdfengineproto_PdfiumRemovePdfAttachmentRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumAttachmentRemovePdfAttachment(argument: _ironpdfengineproto_PdfiumRemovePdfAttachmentRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Attachment_SetPdfAttachmentData(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP>;
  Pdfium_Attachment_SetPdfAttachmentData(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP>;
  Pdfium_Attachment_SetPdfAttachmentData(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP>;
  Pdfium_Attachment_SetPdfAttachmentData(callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP>;
  pdfiumAttachmentSetPdfAttachmentData(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP>;
  pdfiumAttachmentSetPdfAttachmentData(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP>;
  pdfiumAttachmentSetPdfAttachmentData(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP>;
  pdfiumAttachmentSetPdfAttachmentData(callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP>;
  
  Pdfium_BackgroundForeground_AddBackgroundForeground(argument: _ironpdfengineproto_PdfiumAddBackgroundForegroundRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_BackgroundForeground_AddBackgroundForeground(argument: _ironpdfengineproto_PdfiumAddBackgroundForegroundRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_BackgroundForeground_AddBackgroundForeground(argument: _ironpdfengineproto_PdfiumAddBackgroundForegroundRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_BackgroundForeground_AddBackgroundForeground(argument: _ironpdfengineproto_PdfiumAddBackgroundForegroundRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBackgroundForegroundAddBackgroundForeground(argument: _ironpdfengineproto_PdfiumAddBackgroundForegroundRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBackgroundForegroundAddBackgroundForeground(argument: _ironpdfengineproto_PdfiumAddBackgroundForegroundRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBackgroundForegroundAddBackgroundForeground(argument: _ironpdfengineproto_PdfiumAddBackgroundForegroundRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBackgroundForegroundAddBackgroundForeground(argument: _ironpdfengineproto_PdfiumAddBackgroundForegroundRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Bookmark_GetBookmarksDescriptor(argument: _ironpdfengineproto_PdfiumGetBookmarksDescriptorRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetBookmarksDescriptorResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Bookmark_GetBookmarksDescriptor(argument: _ironpdfengineproto_PdfiumGetBookmarksDescriptorRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetBookmarksDescriptorResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Bookmark_GetBookmarksDescriptor(argument: _ironpdfengineproto_PdfiumGetBookmarksDescriptorRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetBookmarksDescriptorResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Bookmark_GetBookmarksDescriptor(argument: _ironpdfengineproto_PdfiumGetBookmarksDescriptorRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetBookmarksDescriptorResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBookmarkGetBookmarksDescriptor(argument: _ironpdfengineproto_PdfiumGetBookmarksDescriptorRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetBookmarksDescriptorResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBookmarkGetBookmarksDescriptor(argument: _ironpdfengineproto_PdfiumGetBookmarksDescriptorRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetBookmarksDescriptorResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBookmarkGetBookmarksDescriptor(argument: _ironpdfengineproto_PdfiumGetBookmarksDescriptorRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetBookmarksDescriptorResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBookmarkGetBookmarksDescriptor(argument: _ironpdfengineproto_PdfiumGetBookmarksDescriptorRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetBookmarksDescriptorResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Bookmark_InsertBookmark(argument: _ironpdfengineproto_PdfiumInsertBookmarkRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Bookmark_InsertBookmark(argument: _ironpdfengineproto_PdfiumInsertBookmarkRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Bookmark_InsertBookmark(argument: _ironpdfengineproto_PdfiumInsertBookmarkRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Bookmark_InsertBookmark(argument: _ironpdfengineproto_PdfiumInsertBookmarkRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBookmarkInsertBookmark(argument: _ironpdfengineproto_PdfiumInsertBookmarkRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBookmarkInsertBookmark(argument: _ironpdfengineproto_PdfiumInsertBookmarkRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBookmarkInsertBookmark(argument: _ironpdfengineproto_PdfiumInsertBookmarkRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBookmarkInsertBookmark(argument: _ironpdfengineproto_PdfiumInsertBookmarkRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Bookmark_RemoveBookmarks(argument: _ironpdfengineproto_PdfiumRemoveBookmarksRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Bookmark_RemoveBookmarks(argument: _ironpdfengineproto_PdfiumRemoveBookmarksRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Bookmark_RemoveBookmarks(argument: _ironpdfengineproto_PdfiumRemoveBookmarksRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Bookmark_RemoveBookmarks(argument: _ironpdfengineproto_PdfiumRemoveBookmarksRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBookmarkRemoveBookmarks(argument: _ironpdfengineproto_PdfiumRemoveBookmarksRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBookmarkRemoveBookmarks(argument: _ironpdfengineproto_PdfiumRemoveBookmarksRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBookmarkRemoveBookmarks(argument: _ironpdfengineproto_PdfiumRemoveBookmarksRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumBookmarkRemoveBookmarks(argument: _ironpdfengineproto_PdfiumRemoveBookmarksRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Compress_CompressImages(argument: _ironpdfengineproto_PdfiumCompressImagesRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Compress_CompressImages(argument: _ironpdfengineproto_PdfiumCompressImagesRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Compress_CompressImages(argument: _ironpdfengineproto_PdfiumCompressImagesRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Compress_CompressImages(argument: _ironpdfengineproto_PdfiumCompressImagesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumCompressCompressImages(argument: _ironpdfengineproto_PdfiumCompressImagesRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_ConvertToPdfA(callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumConvertToPdfARequestStreamP>;
  pdfiumConvertToPdfA(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumConvertToPdfARequestStreamP>;
  pdfiumConvertToPdfA(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumConvertToPdfARequestStreamP>;
  pdfiumConvertToPdfA(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumConvertToPdfARequestStreamP>;
  pdfiumConvertToPdfA(callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumConvertToPdfARequestStreamP>;
  
  Pdfium_ConvertToPdfUA(argument: _ironpdfengineproto_PdfiumConvertToPdfUARequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_ConvertToPdfUA(argument: _ironpdfengineproto_PdfiumConvertToPdfUARequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_ConvertToPdfUA(argument: _ironpdfengineproto_PdfiumConvertToPdfUARequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_ConvertToPdfUA(argument: _ironpdfengineproto_PdfiumConvertToPdfUARequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumConvertToPdfUa(argument: _ironpdfengineproto_PdfiumConvertToPdfUARequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumConvertToPdfUa(argument: _ironpdfengineproto_PdfiumConvertToPdfUARequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_Copy(argument: _ironpdfengineproto_PdfDocumentP, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumCopy(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumCopy(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumCopy(argument: _ironpdfengineproto_PdfDocumentP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumCopy(argument: _ironpdfengineproto_PdfDocumentP, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Dispose(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Dispose(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Dispose(argument: _ironpdfengineproto_PdfDocumentP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Dispose(argument: _ironpdfengineproto_PdfDocumentP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumDispose(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_Form_FlattenForm(argument: _ironpdfengineproto_PdfiumFlattenFormRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormFlattenForm(argument: _ironpdfengineproto_PdfiumFlattenFormRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormFlattenForm(argument: _ironpdfengineproto_PdfiumFlattenFormRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_Form_GetComboboxOptions(argument: _ironpdfengineproto_PdfiumGetComboboxOptionsRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxOptionsResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetComboboxOptions(argument: _ironpdfengineproto_PdfiumGetComboboxOptionsRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxOptionsResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetComboboxOptions(argument: _ironpdfengineproto_PdfiumGetComboboxOptionsRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxOptionsResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetComboboxOptions(argument: _ironpdfengineproto_PdfiumGetComboboxOptionsRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxOptionsResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetComboboxOptions(argument: _ironpdfengineproto_PdfiumGetComboboxOptionsRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxOptionsResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Form_GetComboboxSelectedIndex(argument: _ironpdfengineproto_PdfiumGetComboboxSelectedIndexRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxSelectedIndexResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_GetComboboxSelectedIndex(argument: _ironpdfengineproto_PdfiumGetComboboxSelectedIndexRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxSelectedIndexResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_GetComboboxSelectedIndex(argument: _ironpdfengineproto_PdfiumGetComboboxSelectedIndexRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxSelectedIndexResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_GetComboboxSelectedIndex(argument: _ironpdfengineproto_PdfiumGetComboboxSelectedIndexRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxSelectedIndexResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetComboboxSelectedIndex(argument: _ironpdfengineproto_PdfiumGetComboboxSelectedIndexRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxSelectedIndexResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetComboboxSelectedIndex(argument: _ironpdfengineproto_PdfiumGetComboboxSelectedIndexRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxSelectedIndexResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetComboboxSelectedIndex(argument: _ironpdfengineproto_PdfiumGetComboboxSelectedIndexRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxSelectedIndexResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetComboboxSelectedIndex(argument: _ironpdfengineproto_PdfiumGetComboboxSelectedIndexRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetComboboxSelectedIndexResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Form_GetFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_GetFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_GetFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_GetFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldIsReadOnlyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Form_GetFieldValue(argument: _ironpdfengineproto_PdfiumGetFormFieldValueRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldValueResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_GetFieldValue(argument: _ironpdfengineproto_PdfiumGetFormFieldValueRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldValueResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_GetFieldValue(argument: _ironpdfengineproto_PdfiumGetFormFieldValueRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldValueResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_GetFieldValue(argument: _ironpdfengineproto_PdfiumGetFormFieldValueRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldValueResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetFieldValue(argument: _ironpdfengineproto_PdfiumGetFormFieldValueRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormFieldValueResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_Form_GetForm(argument: _ironpdfengineproto_PdfiumGetFormRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormGetForm(argument: _ironpdfengineproto_PdfiumGetFormRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetFormResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_Form_RenameField(argument: _ironpdfengineproto_PdfiumRenameFieldRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumRenameFormFieldResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormRenameField(argument: _ironpdfengineproto_PdfiumRenameFieldRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumRenameFormFieldResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormRenameField(argument: _ironpdfengineproto_PdfiumRenameFieldRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumRenameFormFieldResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormRenameField(argument: _ironpdfengineproto_PdfiumRenameFieldRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumRenameFormFieldResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormRenameField(argument: _ironpdfengineproto_PdfiumRenameFieldRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumRenameFormFieldResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Form_SetFieldFont(argument: _ironpdfengineproto_PdfiumSetFormFieldFontRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_SetFieldFont(argument: _ironpdfengineproto_PdfiumSetFormFieldFontRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_SetFieldFont(argument: _ironpdfengineproto_PdfiumSetFormFieldFontRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_SetFieldFont(argument: _ironpdfengineproto_PdfiumSetFormFieldFontRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormSetFieldFont(argument: _ironpdfengineproto_PdfiumSetFormFieldFontRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormSetFieldFont(argument: _ironpdfengineproto_PdfiumSetFormFieldFontRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormSetFieldFont(argument: _ironpdfengineproto_PdfiumSetFormFieldFontRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormSetFieldFont(argument: _ironpdfengineproto_PdfiumSetFormFieldFontRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Form_SetFieldValue(argument: _ironpdfengineproto_PdfiumSetFormFieldValueRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_SetFieldValue(argument: _ironpdfengineproto_PdfiumSetFormFieldValueRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_SetFieldValue(argument: _ironpdfengineproto_PdfiumSetFormFieldValueRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_SetFieldValue(argument: _ironpdfengineproto_PdfiumSetFormFieldValueRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormSetFieldValue(argument: _ironpdfengineproto_PdfiumSetFormFieldValueRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormSetFieldValue(argument: _ironpdfengineproto_PdfiumSetFormFieldValueRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormSetFieldValue(argument: _ironpdfengineproto_PdfiumSetFormFieldValueRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormSetFieldValue(argument: _ironpdfengineproto_PdfiumSetFormFieldValueRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Form_SetFormFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumSetFormFieldIsReadOnlyRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_SetFormFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumSetFormFieldIsReadOnlyRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_SetFormFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumSetFormFieldIsReadOnlyRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Form_SetFormFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumSetFormFieldIsReadOnlyRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumFormSetFormFieldIsReadOnly(argument: _ironpdfengineproto_PdfiumSetFormFieldIsReadOnlyRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_FromBytes(callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumPdfDocumentConstructorStreamP>;
  pdfiumFromBytes(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumPdfDocumentConstructorStreamP>;
  pdfiumFromBytes(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumPdfDocumentConstructorStreamP>;
  pdfiumFromBytes(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumPdfDocumentConstructorStreamP>;
  pdfiumFromBytes(callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumPdfDocumentConstructorStreamP>;
  
  Pdfium_GetBinaryData(metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientDuplexStream<_ironpdfengineproto_PdfiumGetBinaryDataRequestStreamP, _ironpdfengineproto_BytesResultStreamP__Output>;
  Pdfium_GetBinaryData(options?: grpc.CallOptions): grpc.ClientDuplexStream<_ironpdfengineproto_PdfiumGetBinaryDataRequestStreamP, _ironpdfengineproto_BytesResultStreamP__Output>;
  pdfiumGetBinaryData(metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientDuplexStream<_ironpdfengineproto_PdfiumGetBinaryDataRequestStreamP, _ironpdfengineproto_BytesResultStreamP__Output>;
  pdfiumGetBinaryData(options?: grpc.CallOptions): grpc.ClientDuplexStream<_ironpdfengineproto_PdfiumGetBinaryDataRequestStreamP, _ironpdfengineproto_BytesResultStreamP__Output>;
  
  Pdfium_GetPaperSizePreset(argument: _ironpdfengineproto_PdfiumGetPaperSizePresetRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPaperSizePresetResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_GetPaperSizePreset(argument: _ironpdfengineproto_PdfiumGetPaperSizePresetRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPaperSizePresetResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_GetPaperSizePreset(argument: _ironpdfengineproto_PdfiumGetPaperSizePresetRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPaperSizePresetResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_GetPaperSizePreset(argument: _ironpdfengineproto_PdfiumGetPaperSizePresetRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPaperSizePresetResultP__Output>): grpc.ClientUnaryCall;
  pdfiumGetPaperSizePreset(argument: _ironpdfengineproto_PdfiumGetPaperSizePresetRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPaperSizePresetResultP__Output>): grpc.ClientUnaryCall;
  pdfiumGetPaperSizePreset(argument: _ironpdfengineproto_PdfiumGetPaperSizePresetRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPaperSizePresetResultP__Output>): grpc.ClientUnaryCall;
  pdfiumGetPaperSizePreset(argument: _ironpdfengineproto_PdfiumGetPaperSizePresetRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPaperSizePresetResultP__Output>): grpc.ClientUnaryCall;
  pdfiumGetPaperSizePreset(argument: _ironpdfengineproto_PdfiumGetPaperSizePresetRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPaperSizePresetResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_GetRevision(argument: _ironpdfengineproto_PdfiumGetRevisionRequestP, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_BytesResultStreamP__Output>;
  Pdfium_GetRevision(argument: _ironpdfengineproto_PdfiumGetRevisionRequestP, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_BytesResultStreamP__Output>;
  pdfiumGetRevision(argument: _ironpdfengineproto_PdfiumGetRevisionRequestP, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_BytesResultStreamP__Output>;
  pdfiumGetRevision(argument: _ironpdfengineproto_PdfiumGetRevisionRequestP, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_BytesResultStreamP__Output>;
  
  Pdfium_GetRevisionCount(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_GetRevisionCount(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_GetRevisionCount(argument: _ironpdfengineproto_PdfDocumentP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_GetRevisionCount(argument: _ironpdfengineproto_PdfDocumentP, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumGetRevisionCount(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumGetRevisionCount(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumGetRevisionCount(argument: _ironpdfengineproto_PdfDocumentP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumGetRevisionCount(argument: _ironpdfengineproto_PdfDocumentP, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_HeaderFooter_AddTextHeaderFooter(argument: _ironpdfengineproto_PdfiumAddTextHeaderFooterRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_HeaderFooter_AddTextHeaderFooter(argument: _ironpdfengineproto_PdfiumAddTextHeaderFooterRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_HeaderFooter_AddTextHeaderFooter(argument: _ironpdfengineproto_PdfiumAddTextHeaderFooterRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_HeaderFooter_AddTextHeaderFooter(argument: _ironpdfengineproto_PdfiumAddTextHeaderFooterRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumHeaderFooterAddTextHeaderFooter(argument: _ironpdfengineproto_PdfiumAddTextHeaderFooterRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumHeaderFooterAddTextHeaderFooter(argument: _ironpdfengineproto_PdfiumAddTextHeaderFooterRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumHeaderFooterAddTextHeaderFooter(argument: _ironpdfengineproto_PdfiumAddTextHeaderFooterRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumHeaderFooterAddTextHeaderFooter(argument: _ironpdfengineproto_PdfiumAddTextHeaderFooterRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Image_DrawBitmap(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumDrawBitmapRequestStreamP>;
  Pdfium_Image_DrawBitmap(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumDrawBitmapRequestStreamP>;
  Pdfium_Image_DrawBitmap(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumDrawBitmapRequestStreamP>;
  Pdfium_Image_DrawBitmap(callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumDrawBitmapRequestStreamP>;
  pdfiumImageDrawBitmap(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumDrawBitmapRequestStreamP>;
  pdfiumImageDrawBitmap(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumDrawBitmapRequestStreamP>;
  pdfiumImageDrawBitmap(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumDrawBitmapRequestStreamP>;
  pdfiumImageDrawBitmap(callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumDrawBitmapRequestStreamP>;
  
  Pdfium_Image_ExtractAllImages(argument: _ironpdfengineproto_PdfiumExtractAllImagesRequestP, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImagesResultStreamP__Output>;
  Pdfium_Image_ExtractAllImages(argument: _ironpdfengineproto_PdfiumExtractAllImagesRequestP, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImagesResultStreamP__Output>;
  pdfiumImageExtractAllImages(argument: _ironpdfengineproto_PdfiumExtractAllImagesRequestP, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImagesResultStreamP__Output>;
  pdfiumImageExtractAllImages(argument: _ironpdfengineproto_PdfiumExtractAllImagesRequestP, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImagesResultStreamP__Output>;
  
  Pdfium_Image_ExtractAllRawImages(argument: _ironpdfengineproto_PdfiumExtractAllRawImagesRequestP, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImagesResultStreamP__Output>;
  Pdfium_Image_ExtractAllRawImages(argument: _ironpdfengineproto_PdfiumExtractAllRawImagesRequestP, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImagesResultStreamP__Output>;
  pdfiumImageExtractAllRawImages(argument: _ironpdfengineproto_PdfiumExtractAllRawImagesRequestP, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImagesResultStreamP__Output>;
  pdfiumImageExtractAllRawImages(argument: _ironpdfengineproto_PdfiumExtractAllRawImagesRequestP, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImagesResultStreamP__Output>;
  
  Pdfium_Image_PdfToImages(argument: _ironpdfengineproto_PdfiumPdfToImagesRequestP, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImagesResultStreamP__Output>;
  Pdfium_Image_PdfToImages(argument: _ironpdfengineproto_PdfiumPdfToImagesRequestP, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImagesResultStreamP__Output>;
  pdfiumImagePdfToImages(argument: _ironpdfengineproto_PdfiumPdfToImagesRequestP, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImagesResultStreamP__Output>;
  pdfiumImagePdfToImages(argument: _ironpdfengineproto_PdfiumPdfToImagesRequestP, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImagesResultStreamP__Output>;
  
  Pdfium_Image_PdfToMultiPageTiffImage(argument: _ironpdfengineproto_PdfiumPdfToMultiPageTiffImageRequestP, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImageResultStreamP__Output>;
  Pdfium_Image_PdfToMultiPageTiffImage(argument: _ironpdfengineproto_PdfiumPdfToMultiPageTiffImageRequestP, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImageResultStreamP__Output>;
  pdfiumImagePdfToMultiPageTiffImage(argument: _ironpdfengineproto_PdfiumPdfToMultiPageTiffImageRequestP, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImageResultStreamP__Output>;
  pdfiumImagePdfToMultiPageTiffImage(argument: _ironpdfengineproto_PdfiumPdfToMultiPageTiffImageRequestP, options?: grpc.CallOptions): grpc.ClientReadableStream<_ironpdfengineproto_ImageResultStreamP__Output>;
  
  Pdfium_IncrementReference(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_IncrementReference(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_IncrementReference(argument: _ironpdfengineproto_PdfDocumentP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_IncrementReference(argument: _ironpdfengineproto_PdfDocumentP, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumIncrementReference(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumIncrementReference(argument: _ironpdfengineproto_PdfDocumentP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumIncrementReference(argument: _ironpdfengineproto_PdfDocumentP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  pdfiumIncrementReference(argument: _ironpdfengineproto_PdfDocumentP, callback: grpc.requestCallback<_ironpdfengineproto_IntResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Metadata_GetMetadata(argument: _ironpdfengineproto_PdfiumGetMetadataRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumMetadataFieldResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_GetMetadata(argument: _ironpdfengineproto_PdfiumGetMetadataRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumMetadataFieldResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_GetMetadata(argument: _ironpdfengineproto_PdfiumGetMetadataRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumMetadataFieldResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_GetMetadata(argument: _ironpdfengineproto_PdfiumGetMetadataRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumMetadataFieldResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataGetMetadata(argument: _ironpdfengineproto_PdfiumGetMetadataRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumMetadataFieldResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataGetMetadata(argument: _ironpdfengineproto_PdfiumGetMetadataRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumMetadataFieldResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataGetMetadata(argument: _ironpdfengineproto_PdfiumGetMetadataRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumMetadataFieldResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataGetMetadata(argument: _ironpdfengineproto_PdfiumGetMetadataRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumMetadataFieldResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Metadata_GetMetadataDict(argument: _ironpdfengineproto_PdfiumGetMetadataDictRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_StringDictionaryResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_GetMetadataDict(argument: _ironpdfengineproto_PdfiumGetMetadataDictRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_StringDictionaryResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_GetMetadataDict(argument: _ironpdfengineproto_PdfiumGetMetadataDictRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_StringDictionaryResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_GetMetadataDict(argument: _ironpdfengineproto_PdfiumGetMetadataDictRequestP, callback: grpc.requestCallback<_ironpdfengineproto_StringDictionaryResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataGetMetadataDict(argument: _ironpdfengineproto_PdfiumGetMetadataDictRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_StringDictionaryResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataGetMetadataDict(argument: _ironpdfengineproto_PdfiumGetMetadataDictRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_StringDictionaryResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataGetMetadataDict(argument: _ironpdfengineproto_PdfiumGetMetadataDictRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_StringDictionaryResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataGetMetadataDict(argument: _ironpdfengineproto_PdfiumGetMetadataDictRequestP, callback: grpc.requestCallback<_ironpdfengineproto_StringDictionaryResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Metadata_GetMetadataKeys(argument: _ironpdfengineproto_PdfiumGetMetadataKeysRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_ListStringResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_GetMetadataKeys(argument: _ironpdfengineproto_PdfiumGetMetadataKeysRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_ListStringResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_GetMetadataKeys(argument: _ironpdfengineproto_PdfiumGetMetadataKeysRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_ListStringResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_GetMetadataKeys(argument: _ironpdfengineproto_PdfiumGetMetadataKeysRequestP, callback: grpc.requestCallback<_ironpdfengineproto_ListStringResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataGetMetadataKeys(argument: _ironpdfengineproto_PdfiumGetMetadataKeysRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_ListStringResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataGetMetadataKeys(argument: _ironpdfengineproto_PdfiumGetMetadataKeysRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_ListStringResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataGetMetadataKeys(argument: _ironpdfengineproto_PdfiumGetMetadataKeysRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_ListStringResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataGetMetadataKeys(argument: _ironpdfengineproto_PdfiumGetMetadataKeysRequestP, callback: grpc.requestCallback<_ironpdfengineproto_ListStringResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Metadata_RemoveMetadata(argument: _ironpdfengineproto_PdfiumRemoveMetadataRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_RemoveMetadata(argument: _ironpdfengineproto_PdfiumRemoveMetadataRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_RemoveMetadata(argument: _ironpdfengineproto_PdfiumRemoveMetadataRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_RemoveMetadata(argument: _ironpdfengineproto_PdfiumRemoveMetadataRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataRemoveMetadata(argument: _ironpdfengineproto_PdfiumRemoveMetadataRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataRemoveMetadata(argument: _ironpdfengineproto_PdfiumRemoveMetadataRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataRemoveMetadata(argument: _ironpdfengineproto_PdfiumRemoveMetadataRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataRemoveMetadata(argument: _ironpdfengineproto_PdfiumRemoveMetadataRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Metadata_SetMetadata(argument: _ironpdfengineproto_PdfiumSetMetadataRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_SetMetadata(argument: _ironpdfengineproto_PdfiumSetMetadataRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_SetMetadata(argument: _ironpdfengineproto_PdfiumSetMetadataRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_SetMetadata(argument: _ironpdfengineproto_PdfiumSetMetadataRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataSetMetadata(argument: _ironpdfengineproto_PdfiumSetMetadataRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataSetMetadata(argument: _ironpdfengineproto_PdfiumSetMetadataRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataSetMetadata(argument: _ironpdfengineproto_PdfiumSetMetadataRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataSetMetadata(argument: _ironpdfengineproto_PdfiumSetMetadataRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Metadata_SetMetadataDict(argument: _ironpdfengineproto_PdfiumSetMetadataDictRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_SetMetadataDict(argument: _ironpdfengineproto_PdfiumSetMetadataDictRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_SetMetadataDict(argument: _ironpdfengineproto_PdfiumSetMetadataDictRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Metadata_SetMetadataDict(argument: _ironpdfengineproto_PdfiumSetMetadataDictRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataSetMetadataDict(argument: _ironpdfengineproto_PdfiumSetMetadataDictRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataSetMetadataDict(argument: _ironpdfengineproto_PdfiumSetMetadataDictRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataSetMetadataDict(argument: _ironpdfengineproto_PdfiumSetMetadataDictRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumMetadataSetMetadataDict(argument: _ironpdfengineproto_PdfiumSetMetadataDictRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_Page_CopyPages(argument: _ironpdfengineproto_PdfiumCopyPagesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageCopyPages(argument: _ironpdfengineproto_PdfiumCopyPagesRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageCopyPages(argument: _ironpdfengineproto_PdfiumCopyPagesRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageCopyPages(argument: _ironpdfengineproto_PdfiumCopyPagesRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageCopyPages(argument: _ironpdfengineproto_PdfiumCopyPagesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Page_GetPage(argument: _ironpdfengineproto_PdfiumGetPageRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPageResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_GetPage(argument: _ironpdfengineproto_PdfiumGetPageRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPageResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_GetPage(argument: _ironpdfengineproto_PdfiumGetPageRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPageResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_GetPage(argument: _ironpdfengineproto_PdfiumGetPageRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPageResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageGetPage(argument: _ironpdfengineproto_PdfiumGetPageRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPageResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_Page_GetPageCount(argument: _ironpdfengineproto_PdfiumGetPageCountRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPageCountResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageGetPageCount(argument: _ironpdfengineproto_PdfiumGetPageCountRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPageCountResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageGetPageCount(argument: _ironpdfengineproto_PdfiumGetPageCountRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPageCountResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageGetPageCount(argument: _ironpdfengineproto_PdfiumGetPageCountRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPageCountResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageGetPageCount(argument: _ironpdfengineproto_PdfiumGetPageCountRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPageCountResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Page_GetPages(argument: _ironpdfengineproto_PdfiumGetPagesRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPagesResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_GetPages(argument: _ironpdfengineproto_PdfiumGetPagesRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPagesResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_GetPages(argument: _ironpdfengineproto_PdfiumGetPagesRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPagesResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_GetPages(argument: _ironpdfengineproto_PdfiumGetPagesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPagesResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageGetPages(argument: _ironpdfengineproto_PdfiumGetPagesRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPagesResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageGetPages(argument: _ironpdfengineproto_PdfiumGetPagesRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPagesResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageGetPages(argument: _ironpdfengineproto_PdfiumGetPagesRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPagesResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageGetPages(argument: _ironpdfengineproto_PdfiumGetPagesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPagesResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Page_InsertPdf(argument: _ironpdfengineproto_PdfiumPdfDocumentInsertRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_InsertPdf(argument: _ironpdfengineproto_PdfiumPdfDocumentInsertRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_InsertPdf(argument: _ironpdfengineproto_PdfiumPdfDocumentInsertRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_InsertPdf(argument: _ironpdfengineproto_PdfiumPdfDocumentInsertRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageInsertPdf(argument: _ironpdfengineproto_PdfiumPdfDocumentInsertRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageInsertPdf(argument: _ironpdfengineproto_PdfiumPdfDocumentInsertRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageInsertPdf(argument: _ironpdfengineproto_PdfiumPdfDocumentInsertRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageInsertPdf(argument: _ironpdfengineproto_PdfiumPdfDocumentInsertRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Page_Merge(argument: _ironpdfengineproto_PdfiumPdfDocumentMergeRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_Merge(argument: _ironpdfengineproto_PdfiumPdfDocumentMergeRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_Merge(argument: _ironpdfengineproto_PdfiumPdfDocumentMergeRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_Merge(argument: _ironpdfengineproto_PdfiumPdfDocumentMergeRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageMerge(argument: _ironpdfengineproto_PdfiumPdfDocumentMergeRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_Page_RemovePages(argument: _ironpdfengineproto_PdfiumRemovePagesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumRemovePagesResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageRemovePages(argument: _ironpdfengineproto_PdfiumRemovePagesRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumRemovePagesResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageRemovePages(argument: _ironpdfengineproto_PdfiumRemovePagesRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumRemovePagesResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageRemovePages(argument: _ironpdfengineproto_PdfiumRemovePagesRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumRemovePagesResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageRemovePages(argument: _ironpdfengineproto_PdfiumRemovePagesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumRemovePagesResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Page_ResizePage(argument: _ironpdfengineproto_PdfiumResizePageRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_ResizePage(argument: _ironpdfengineproto_PdfiumResizePageRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_ResizePage(argument: _ironpdfengineproto_PdfiumResizePageRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_ResizePage(argument: _ironpdfengineproto_PdfiumResizePageRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageResizePage(argument: _ironpdfengineproto_PdfiumResizePageRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageResizePage(argument: _ironpdfengineproto_PdfiumResizePageRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageResizePage(argument: _ironpdfengineproto_PdfiumResizePageRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageResizePage(argument: _ironpdfengineproto_PdfiumResizePageRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Page_SetPagesRotation(argument: _ironpdfengineproto_PdfiumSetPagesRotationRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_SetPagesRotation(argument: _ironpdfengineproto_PdfiumSetPagesRotationRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_SetPagesRotation(argument: _ironpdfengineproto_PdfiumSetPagesRotationRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_SetPagesRotation(argument: _ironpdfengineproto_PdfiumSetPagesRotationRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageSetPagesRotation(argument: _ironpdfengineproto_PdfiumSetPagesRotationRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageSetPagesRotation(argument: _ironpdfengineproto_PdfiumSetPagesRotationRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageSetPagesRotation(argument: _ironpdfengineproto_PdfiumSetPagesRotationRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageSetPagesRotation(argument: _ironpdfengineproto_PdfiumSetPagesRotationRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Security_GetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumGetPdfSecuritySettingsRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfSecuritySettingsResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Security_GetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumGetPdfSecuritySettingsRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfSecuritySettingsResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Security_GetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumGetPdfSecuritySettingsRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfSecuritySettingsResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Security_GetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumGetPdfSecuritySettingsRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfSecuritySettingsResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSecurityGetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumGetPdfSecuritySettingsRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfSecuritySettingsResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSecurityGetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumGetPdfSecuritySettingsRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfSecuritySettingsResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSecurityGetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumGetPdfSecuritySettingsRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfSecuritySettingsResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSecurityGetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumGetPdfSecuritySettingsRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetPdfSecuritySettingsResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Security_RemovePasswordsAndEncryption(argument: _ironpdfengineproto_PdfiumRemovePasswordsAndEncryptionRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Security_RemovePasswordsAndEncryption(argument: _ironpdfengineproto_PdfiumRemovePasswordsAndEncryptionRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Security_RemovePasswordsAndEncryption(argument: _ironpdfengineproto_PdfiumRemovePasswordsAndEncryptionRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Security_RemovePasswordsAndEncryption(argument: _ironpdfengineproto_PdfiumRemovePasswordsAndEncryptionRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSecurityRemovePasswordsAndEncryption(argument: _ironpdfengineproto_PdfiumRemovePasswordsAndEncryptionRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSecurityRemovePasswordsAndEncryption(argument: _ironpdfengineproto_PdfiumRemovePasswordsAndEncryptionRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSecurityRemovePasswordsAndEncryption(argument: _ironpdfengineproto_PdfiumRemovePasswordsAndEncryptionRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSecurityRemovePasswordsAndEncryption(argument: _ironpdfengineproto_PdfiumRemovePasswordsAndEncryptionRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Security_SetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumSetPdfSecuritySettingsRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Security_SetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumSetPdfSecuritySettingsRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Security_SetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumSetPdfSecuritySettingsRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Security_SetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumSetPdfSecuritySettingsRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSecuritySetPdfSecuritySettings(argument: _ironpdfengineproto_PdfiumSetPdfSecuritySettingsRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfDocumentResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_Signature_GetSignatureCount(argument: _ironpdfengineproto_PdfiumGetSignatureCountRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetSignatureCountResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSignatureGetSignatureCount(argument: _ironpdfengineproto_PdfiumGetSignatureCountRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetSignatureCountResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSignatureGetSignatureCount(argument: _ironpdfengineproto_PdfiumGetSignatureCountRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetSignatureCountResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSignatureGetSignatureCount(argument: _ironpdfengineproto_PdfiumGetSignatureCountRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetSignatureCountResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSignatureGetSignatureCount(argument: _ironpdfengineproto_PdfiumGetSignatureCountRequestP, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetSignatureCountResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Signature_GetVerifiedSignature(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetVerifySignatureResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumGetVerifiedSignatureRequestStreamP>;
  Pdfium_Signature_GetVerifiedSignature(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetVerifySignatureResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumGetVerifiedSignatureRequestStreamP>;
  Pdfium_Signature_GetVerifiedSignature(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetVerifySignatureResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumGetVerifiedSignatureRequestStreamP>;
  Pdfium_Signature_GetVerifiedSignature(callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetVerifySignatureResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumGetVerifiedSignatureRequestStreamP>;
  pdfiumSignatureGetVerifiedSignature(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetVerifySignatureResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumGetVerifiedSignatureRequestStreamP>;
  pdfiumSignatureGetVerifiedSignature(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetVerifySignatureResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumGetVerifiedSignatureRequestStreamP>;
  pdfiumSignatureGetVerifiedSignature(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetVerifySignatureResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumGetVerifiedSignatureRequestStreamP>;
  pdfiumSignatureGetVerifiedSignature(callback: grpc.requestCallback<_ironpdfengineproto_PdfiumGetVerifySignatureResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumGetVerifiedSignatureRequestStreamP>;
  
  Pdfium_Signature_RemoveSignatures(argument: _ironpdfengineproto_PdfiumRemoveSignaturesRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Signature_RemoveSignatures(argument: _ironpdfengineproto_PdfiumRemoveSignaturesRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Signature_RemoveSignatures(argument: _ironpdfengineproto_PdfiumRemoveSignaturesRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Signature_RemoveSignatures(argument: _ironpdfengineproto_PdfiumRemoveSignaturesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSignatureRemoveSignatures(argument: _ironpdfengineproto_PdfiumRemoveSignaturesRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSignatureRemoveSignatures(argument: _ironpdfengineproto_PdfiumRemoveSignaturesRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSignatureRemoveSignatures(argument: _ironpdfengineproto_PdfiumRemoveSignaturesRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumSignatureRemoveSignatures(argument: _ironpdfengineproto_PdfiumRemoveSignaturesRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  Pdfium_Signature_Sign(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumSignResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSignRequestStreamP>;
  Pdfium_Signature_Sign(metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumSignResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSignRequestStreamP>;
  Pdfium_Signature_Sign(options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumSignResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSignRequestStreamP>;
  Pdfium_Signature_Sign(callback: grpc.requestCallback<_ironpdfengineproto_PdfiumSignResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSignRequestStreamP>;
  pdfiumSignatureSign(metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_PdfiumSignResultP__Output>): grpc.ClientWritableStream<_ironpdfengineproto_PdfiumSignRequestStreamP>;
  ...
  Pdfium_Text_DrawText(argument: _ironpdfengineproto_PdfiumDrawTextRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumTextDrawText(argument: _ironpdfengineproto_PdfiumDrawTextRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_Text_ExtractAllText(argument: _ironpdfengineproto_PdfiumExtractAllTextRequestP, callback: grpc.requestCallback<_ironpdfengineproto_StringResultP__Output>): grpc.ClientUnaryCall;
  pdfiumTextExtractAllText(argument: _ironpdfengineproto_PdfiumExtractAllTextRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_StringResultP__Output>): grpc.ClientUnaryCall;
  ...
  Pdfium_Text_ReplaceText(argument: _ironpdfengineproto_PdfiumReplaceTextRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumTextReplaceText(argument: _ironpdfengineproto_PdfiumReplaceTextRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  ...
  System_License_IsLicensed(argument: _ironpdfengineproto_SystemIsLicensedRequestP, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  systemLicenseIsLicensed(argument: _ironpdfengineproto_SystemIsLicensedRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  systemLicenseIsLicensed(argument: _ironpdfengineproto_SystemIsLicensedRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  systemLicenseIsLicensed(argument: _ironpdfengineproto_SystemIsLicensedRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  systemLicenseIsLicensed(argument: _ironpdfengineproto_SystemIsLicensedRequestP, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  
  System_License_IsValidLicense(argument: _ironpdfengineproto_SystemIsValidLicenseRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  System_License_IsValidLicense(argument: _ironpdfengineproto_SystemIsValidLicenseRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  System_License_IsValidLicense(argument: _ironpdfengineproto_SystemIsValidLicenseRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  System_License_IsValidLicense(argument: _ironpdfengineproto_SystemIsValidLicenseRequestP, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  systemLicenseIsValidLicense(argument: _ironpdfengineproto_SystemIsValidLicenseRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  systemLicenseIsValidLicense(argument: _ironpdfengineproto_SystemIsValidLicenseRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  systemLicenseIsValidLicense(argument: _ironpdfengineproto_SystemIsValidLicenseRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  systemLicenseIsValidLicense(argument: _ironpdfengineproto_SystemIsValidLicenseRequestP, callback: grpc.requestCallback<_ironpdfengineproto_BooleanResultP__Output>): grpc.ClientUnaryCall;
  
  System_License_SetLicenseKey(argument: _ironpdfengineproto_SystemSetLicenseKeyRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  System_License_SetLicenseKey(argument: _ironpdfengineproto_SystemSetLicenseKeyRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  System_License_SetLicenseKey(argument: _ironpdfengineproto_SystemSetLicenseKeyRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  System_License_SetLicenseKey(argument: _ironpdfengineproto_SystemSetLicenseKeyRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  systemLicenseSetLicenseKey(argument: _ironpdfengineproto_SystemSetLicenseKeyRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  systemLicenseSetLicenseKey(argument: _ironpdfengineproto_SystemSetLicenseKeyRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  systemLicenseSetLicenseKey(argument: _ironpdfengineproto_SystemSetLicenseKeyRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  systemLicenseSetLicenseKey(argument: _ironpdfengineproto_SystemSetLicenseKeyRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
  System_Logger_SetIsDebug(argument: _ironpdfengineproto_SystemSetIsDebugRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  System_Logger_SetIsDebug(argument: _ironpdfengineproto_SystemSetIsDebugRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  System_Logger_SetIsDebug(argument: _ironpdfengineproto_SystemSetIsDebugRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  System_Logger_SetIsDebug(argument: _ironpdfengineproto_SystemSetIsDebugRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  systemLoggerSetIsDebug(argument: _ironpdfengineproto_SystemSetIsDebugRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  systemLoggerSetIsDebug(argument: _ironpdfengineproto_SystemSetIsDebugRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  systemLoggerSetIsDebug(argument: _ironpdfengineproto_SystemSetIsDebugRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  systemLoggerSetIsDebug(argument: _ironpdfengineproto_SystemSetIsDebugRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  
}

export interface IronPdfServiceHandlers extends grpc.UntypedServiceImplementation {
  Chrome_HeaderFooter_AddHtmlHeaderFooter: grpc.handleUnaryCall<_ironpdfengineproto_ChromeAddHtmlHeaderFooterRequestP__Output, _ironpdfengineproto_EmptyResultP>;
  
  Chrome_Image_ImageFilesToPdf: grpc.handleClientStreamingCall<_ironpdfengineproto_ChromeImageFilesToPdfRequestStreamP__Output, _ironpdfengineproto_PdfDocumentResultP>;
  
  Chrome_Image_ImageToPdf: grpc.handleClientStreamingCall<_ironpdfengineproto_ChromeImageToPdfRequestStreamP__Output, _ironpdfengineproto_PdfDocumentResultP>;
  ...
  Pdfium_Attachment_GetPdfAttachmentCount: grpc.handleUnaryCall<_ironpdfengineproto_PdfiumGetPdfAttachmentCountRequestP__Output, _ironpdfengineproto_PdfiumGetPdfAttachmentCountResultP>;
  
  Pdfium_Attachment_GetPdfAttachmentData: grpc.handleServerStreamingCall<_ironpdfengineproto_PdfiumGetPdfAttachmentDataRequestP__Output, _ironpdfengineproto_PdfiumGetPdfAttachmentDataResultStreamP>;
  
  Pdfium_Attachment_GetPdfAttachmentName: grpc.handleUnaryCall<_ironpdfengineproto_PdfiumGetPdfAttachmentNameRequestP__Output, _ironpdfengineproto_PdfiumGetPdfAttachmentNameResultP>;
  
  Pdfium_Attachment_RemovePdfAttachment: grpc.handleUnaryCall<_ironpdfengineproto_PdfiumRemovePdfAttachmentRequestP__Output, _ironpdfengineproto_EmptyResultP>;
  
  Pdfium_Attachment_SetPdfAttachmentData: grpc.handleClientStreamingCall<_ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP__Output, _ironpdfengineproto_EmptyResultP>;
  
  Pdfium_BackgroundForeground_AddBackgroundForeground: grpc.handleUnaryCall<_ironpdfengineproto_PdfiumAddBackgroundForegroundRequestP__Output, _ironpdfengineproto_EmptyResultP>;
  
  Pdfium_Bookmark_GetBookmarksDescriptor: grpc.handleUnaryCall<_ironpdfengineproto_PdfiumGetBookmarksDescriptorRequestP__Output, _ironpdfengineproto_PdfiumGetBookmarksDescriptorResultP>;
  ...
  Pdfium_GetRevision: grpc.handleServerStreamingCall<_ironpdfengineproto_PdfiumGetRevisionRequestP__Output, _ironpdfengineproto_BytesResultStreamP>;
  
  Pdfium_GetRevisionCount: grpc.handleUnaryCall<_ironpdfengineproto_PdfDocumentP__Output, _ironpdfengineproto_IntResultP>;
  
  Pdfium_HeaderFooter_AddTextHeaderFooter: grpc.handleUnaryCall<_ironpdfengineproto_PdfiumAddTextHeaderFooterRequestP__Output, _ironpdfengineproto_EmptyResultP>;
  
  Pdfium_Image_DrawBitmap: grpc.handleClientStreamingCall<_ironpdfengineproto_PdfiumDrawBitmapRequestStreamP__Output, _ironpdfengineproto_EmptyResultP>;
  
  Pdfium_Image_ExtractAllImages: grpc.handleServerStreamingCall<_ironpdfengineproto_PdfiumExtractAllImagesRequestP__Output, _ironpdfengineproto_ImagesResultStreamP>;
  
  Pdfium_Image_ExtractAllRawImages: grpc.handleServerStreamingCall<_ironpdfengineproto_PdfiumExtractAllRawImagesRequestP__Output, _ironpdfengineproto_ImagesResultStreamP>;
  
  Pdfium_Image_PdfToImages: grpc.handleServerStreamingCall<_ironpdfengineproto_PdfiumPdfToImagesRequestP__Output, _ironpdfengineproto_ImagesResultStreamP>;
  
  Pdfium_Image_PdfToMultiPageTiffImage: grpc.handleServerStreamingCall<_ironpdfengineproto_PdfiumPdfToMultiPageTiffImageRequestP__Output, _ironpdfengineproto_ImageResultStreamP>;
  
  Pdfium_IncrementReference: grpc.handleUnaryCall<_ironpdfengineproto_PdfDocumentP__Output, _ironpdfengineproto_IntResultP>;
  
  Pdfium_Metadata_GetMetadata: grpc.handleUnaryCall<_ironpdfengineproto_PdfiumGetMetadataRequestP__Output, _ironpdfengineproto_PdfiumMetadataFieldResultP>;
  
  Pdfium_Metadata_GetMetadataDict: grpc.handleUnaryCall<_ironpdfengineproto_PdfiumGetMetadataDictRequestP__Output, _ironpdfengineproto_StringDictionaryResultP>;
  
  Pdfium_Metadata_GetMetadataKeys: grpc.handleUnaryCall<_ironpdfengineproto_PdfiumGetMetadataKeysRequestP__Output, _ironpdfengineproto_ListStringResultP>;
  
  Pdfium_Metadata_RemoveMetadata: grpc.handleUnaryCall<_ironpdfengineproto_PdfiumRemoveMetadataRequestP__Output, _ironpdfengineproto_EmptyResultP>;
  
  Pdfium_Metadata_SetMetadata: grpc.handleUnaryCall<_ironpdfengineproto_PdfiumSetMetadataRequestP__Output, _ironpdfengineproto_EmptyResultP>;
  ...
  System_Logger_SetIsDebug: grpc.handleUnaryCall<_ironpdfengineproto_SystemSetIsDebugRequestP__Output, _ironpdfengineproto_EmptyResultP>;
  
}

export interface IronPdfServiceDefinition extends grpc.ServiceDefinition {
  Chrome_HeaderFooter_AddHtmlHeaderFooter: MethodDefinition<_ironpdfengineproto_ChromeAddHtmlHeaderFooterRequestP, _ironpdfengineproto_EmptyResultP, _ironpdfengineproto_ChromeAddHtmlHeaderFooterRequestP__Output, _ironpdfengineproto_EmptyResultP__Output>
  Chrome_Image_ImageFilesToPdf: MethodDefinition<_ironpdfengineproto_ChromeImageFilesToPdfRequestStreamP, _ironpdfengineproto_PdfDocumentResultP, _ironpdfengineproto_ChromeImageFilesToPdfRequestStreamP__Output, _ironpdfengineproto_PdfDocumentResultP__Output>
  Chrome_Image_ImageToPdf: MethodDefinition<_ironpdfengineproto_ChromeImageToPdfRequestStreamP, _ironpdfengineproto_PdfDocumentResultP, _ironpdfengineproto_ChromeImageToPdfRequestStreamP__Output, _ironpdfengineproto_PdfDocumentResultP__Output>
  ...
  Pdfium_Attachment_GetPdfAttachmentCount: MethodDefinition<_ironpdfengineproto_PdfiumGetPdfAttachmentCountRequestP, _ironpdfengineproto_PdfiumGetPdfAttachmentCountResultP, _ironpdfengineproto_PdfiumGetPdfAttachmentCountRequestP__Output, _ironpdfengineproto_PdfiumGetPdfAttachmentCountResultP__Output>
  Pdfium_Attachment_GetPdfAttachmentData: MethodDefinition<_ironpdfengineproto_PdfiumGetPdfAttachmentDataRequestP, _ironpdfengineproto_PdfiumGetPdfAttachmentDataResultStreamP, _ironpdfengineproto_PdfiumGetPdfAttachmentDataRequestP__Output, _ironpdfengineproto_PdfiumGetPdfAttachmentDataResultStreamP__Output>
  Pdfium_Attachment_GetPdfAttachmentName: MethodDefinition<_ironpdfengineproto_PdfiumGetPdfAttachmentNameRequestP, _ironpdfengineproto_PdfiumGetPdfAttachmentNameResultP, _ironpdfengineproto_PdfiumGetPdfAttachmentNameRequestP__Output, _ironpdfengineproto_PdfiumGetPdfAttachmentNameResultP__Output>
  Pdfium_Attachment_RemovePdfAttachment: MethodDefinition<_ironpdfengineproto_PdfiumRemovePdfAttachmentRequestP, _ironpdfengineproto_EmptyResultP, _ironpdfengineproto_PdfiumRemovePdfAttachmentRequestP__Output, _ironpdfengineproto_EmptyResultP__Output>
  Pdfium_Attachment_SetPdfAttachmentData: MethodDefinition<_ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP, _ironpdfengineproto_EmptyResultP, _ironpdfengineproto_PdfiumSetPdfAttachmentDataRequestStreamP__Output, _ironpdfengineproto_EmptyResultP__Output>
  Pdfium_BackgroundForeground_AddBackgroundForeground: MethodDefinition<_ironpdfengineproto_PdfiumAddBackgroundForegroundRequestP, _ironpdfengineproto_EmptyResultP, _ironpdfengineproto_PdfiumAddBackgroundForegroundRequestP__Output, _ironpdfengineproto_EmptyResultP__Output>
  Pdfium_Bookmark_GetBookmarksDescriptor: MethodDefinition<_ironpdfengineproto_PdfiumGetBookmarksDescriptorRequestP, _ironpdfengineproto_PdfiumGetBookmarksDescriptorResultP, _ironpdfengineproto_PdfiumGetBookmarksDescriptorRequestP__Output, _ironpdfengineproto_PdfiumGetBookmarksDescriptorResultP__Output>
  ...
  Pdfium_GetRevision: MethodDefinition<_ironpdfengineproto_PdfiumGetRevisionRequestP, _ironpdfengineproto_BytesResultStreamP, _ironpdfengineproto_PdfiumGetRevisionRequestP__Output, _ironpdfengineproto_BytesResultStreamP__Output>
  Pdfium_GetRevisionCount: MethodDefinition<_ironpdfengineproto_PdfDocumentP, _ironpdfengineproto_IntResultP, _ironpdfengineproto_PdfDocumentP__Output, _ironpdfengineproto_IntResultP__Output>
  Pdfium_HeaderFooter_AddTextHeaderFooter: MethodDefinition<_ironpdfengineproto_PdfiumAddTextHeaderFooterRequestP, _ironpdfengineproto_EmptyResultP, _ironpdfengineproto_PdfiumAddTextHeaderFooterRequestP__Output, _ironpdfengineproto_EmptyResultP__Output>
  Pdfium_Image_DrawBitmap: MethodDefinition<_ironpdfengineproto_PdfiumDrawBitmapRequestStreamP, _ironpdfengineproto_EmptyResultP, _ironpdfengineproto_PdfiumDrawBitmapRequestStreamP__Output, _ironpdfengineproto_EmptyResultP__Output>
  Pdfium_Image_ExtractAllImages: MethodDefinition<_ironpdfengineproto_PdfiumExtractAllImagesRequestP, _ironpdfengineproto_ImagesResultStreamP, _ironpdfengineproto_PdfiumExtractAllImagesRequestP__Output, _ironpdfengineproto_ImagesResultStreamP__Output>
  Pdfium_Image_ExtractAllRawImages: MethodDefinition<_ironpdfengineproto_PdfiumExtractAllRawImagesRequestP, _ironpdfengineproto_ImagesResultStreamP, _ironpdfengineproto_PdfiumExtractAllRawImagesRequestP__Output, _ironpdfengineproto_ImagesResultStreamP__Output>
  Pdfium_Image_PdfToImages: MethodDefinition<_ironpdfengineproto_PdfiumPdfToImagesRequestP, _ironpdfengineproto_ImagesResultStreamP, _ironpdfengineproto_PdfiumPdfToImagesRequestP__Output, _ironpdfengineproto_ImagesResultStreamP__Output>
  Pdfium_Image_PdfToMultiPageTiffImage: MethodDefinition<_ironpdfengineproto_PdfiumPdfToMultiPageTiffImageRequestP, _ironpdfengineproto_ImageResultStreamP, _ironpdfengineproto_PdfiumPdfToMultiPageTiffImageRequestP__Output, _ironpdfengineproto_ImageResultStreamP__Output>
  Pdfium_IncrementReference: MethodDefinition<_ironpdfengineproto_PdfDocumentP, _ironpdfengineproto_IntResultP, _ironpdfengineproto_PdfDocumentP__Output, _ironpdfengineproto_IntResultP__Output>
  Pdfium_Metadata_GetMetadata: MethodDefinition<_ironpdfengineproto_PdfiumGetMetadataRequestP, _ironpdfengineproto_PdfiumMetadataFieldResultP, _ironpdfengineproto_PdfiumGetMetadataRequestP__Output, _ironpdfengineproto_PdfiumMetadataFieldResultP__Output>
  Pdfium_Metadata_GetMetadataDict: MethodDefinition<_ironpdfengineproto_PdfiumGetMetadataDictRequestP, _ironpdfengineproto_StringDictionaryResultP, _ironpdfengineproto_PdfiumGetMetadataDictRequestP__Output, _ironpdfengineproto_StringDictionaryResultP__Output>
  Pdfium_Metadata_GetMetadataKeys: MethodDefinition<_ironpdfengineproto_PdfiumGetMetadataKeysRequestP, _ironpdfengineproto_ListStringResultP, _ironpdfengineproto_PdfiumGetMetadataKeysRequestP__Output, _ironpdfengineproto_ListStringResultP__Output>
  Pdfium_Metadata_RemoveMetadata: MethodDefinition<_ironpdfengineproto_PdfiumRemoveMetadataRequestP, _ironpdfengineproto_EmptyResultP, _ironpdfengineproto_PdfiumRemoveMetadataRequestP__Output, _ironpdfengineproto_EmptyResultP__Output>
  ...
  System_Logger_SetIsDebug: MethodDefinition<_ironpdfengineproto_SystemSetIsDebugRequestP, _ironpdfengineproto_EmptyResultP, _ironpdfengineproto_SystemSetIsDebugRequestP__Output, _ironpdfengineproto_EmptyResultP__Output>
}
